 ...
 * 
 */
@WebServiceClient(name = "BankServices", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:1010/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANKSERVICES_QNAME = new QName("http://ws/", "BankServices");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1010/?wsdl");
